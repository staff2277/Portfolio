 ...
 * camera writes. Defaults to false; HeroScene.js currently has no reveal
 * gate to tie this to (PageTransitionProvider was removed in an earlier
 * session -- see handoff.md), so it's just always active once mounted.
 */
