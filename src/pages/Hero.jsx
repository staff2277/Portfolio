...
const Hero = () => {
  ...
  return (
    <PageTransition>
      <Helmet>
        <title>Mustapha Osman | Front-End Developer</title>
        <meta name="description" content="Portfolio of Mustapha Osman, a Front-End Developer creating premium web experiences." />
      </Helmet>
